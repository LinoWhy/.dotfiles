      ...
      require("catppuccin").setup({
        ...
        custom_highlights = function(c)
          ...
          return {
            ...
            MatchParen = { fg = c.red, bg = "none", style = { "bold", "reverse", "italic" } }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
